<template>
  <div
    style="height: 100%"
    class="u-flex justify-content-center align-items-center slider-4"
  >
    <div class="col-8">
      <h2 class="h2 u-blue u-center u-yellow">EAU</h2>
      <p class="u-center">La consommation d'eau en france ...</p>
